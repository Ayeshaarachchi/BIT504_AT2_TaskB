...
public class GameMain extends JPanel implements MouseListener{
	...
	public GameMain() {   
	    ...
	    //this is to add mouse clicked event to our game
	...
	public static void main(String[] args) {
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
	         public void run() {
				...
				// create a new GameMain panel
				GameMain newGameMain= new GameMain();
	...
	public void paintComponent(Graphics g) {
		...
		if (currentState == GameState.Playing) {          
			...
			if (currentPlayer == Player.Cross) {   
				...
				statusBar.setText("NOW IT IS X TURN: ");
				
			} else {    
				
				//TODO: use the status bar to display the message "O"'s Turn
				////status bar message changed
				statusBar.setText("NOW IT IS Y TURN ");
	  ...
	  /** Initialise the game-board contents and the current status of GameState and Player) */
		...
		public void updateGame(Player thePlayer, int row, int col) {
			...
			if(board.hasWon(thePlayer, row, col)) {
				...
				//if player who plays by inserting crosses wins
